  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal(data-aos="flip-up")
      .titulo-principal__numero
        span 2
      h1 Arquitectura #[i web]

    p(data-aos="flip-up") Es la estructura funcional de un sitio #[i web], creando un mapa jerárquico de todas las páginas y la relación entre ellas, de una forma lógica y coherente.

    p(data-aos="flip-up") La estructura de un sitio #[i web] cuenta con varias páginas y se distribuyen en forma de mapa, agrupando de forma lógica y jerárquica las páginas que comparten un mismo criterio para facilidad de navegación de los usuarios o clientes.
      ...
      SlyderA
        .row.align-items-center.justify-content-center
          .col-md-5.mb-4.mb-md-0
            h4 Link Juice
            p Se le denomina a la estructura interna y robusta que puede tener un sitio #[i web], dado que este contiene el valor SEO (#[i Search Engine Optimization]) de cada una de las páginas. 
            p Esto permite que los sitios #[i web] se puedan clasificar y sean indexados por los usuarios en los motores de búsqueda.
        ...
        .row.align-items-center.justify-content-center
          .col-md-8.mb-4.mb-md-0
            h4.mb-5 Fundamentos de la arquitectura #[i web]
            figure.mb-3
              img.img-a(src='@/assets/curso/tema_1/img_37.svg', alt='Texto que describa la imagen')
    ...
    p.mb-5(data-aos="flip-up") La arquitectura #[i web] es el ordenamiento y jerarquización del contenido de un sitio #[i web], en el cual se trabaja bajo los estándares de los sitios #[i web] y las categorías que conforman la optimización y cara al posicionamiento en los buscadores, interacción y experiencia de usuarios (UX). El objetivo es resolver las necesidades del cliente, que posiblemente necesite o busque un producto #[i software] #[i online] y se dé respuesta por medio de una implementación #[i web]. 
    ...
    .bloque-texto-g.color-acento-botones.p-3.p-sm-4.p-md-5.mb-5(data-aos="flip-up")
      ...
      .bloque-texto-g__texto.p-4
        p.mb-0 Algunos de los conceptos base para desglosar la arquitectura #[i web] son la taxonomía #[i web] y la ontología #[i web], donde la primera hace referencia a los diferentes términos que dividen un sitio #[i web] y la segunda nos habla de las relaciones entre los diferentes ítems de navegación. 

    p.mb-5(data-aos="flip-up") En la arquitectura #[i web] también se incluye el diseño de interfaz de usuario, el diseño de la aplicación y la estructura de la información, con lo cual hay un enfoque del aspecto visual, colores, tamaños de letra, estructura de las diferentes secciones, las funcionalidades segregadas en cada una de las vistas del sitio #[i web] y por último, se determina la información que debe existir en cada una de las secciones del sitio #[i web] y que se verá reflejado en un ambiente productivo. 
    ...
    .row.mb-5(data-aos="flip-up")
      .col-lg-6
        p.txt_03 En un producto #[i software] se puede encontrar diferentes tipos de soluciones, como por ejemplo una 
    ...
    .cajon.color-secundario.p-4.mb-5(data-aos="flip-up")
      p #[strong.recua_bg2.p-1 Desarrollo #[i Frontend]:] se puede traducir como frente o fachada final, esta vertiente del desarrollo de #[i software] es una especialidad para el desarrollo #[i web] y concentra lo que se define como interfaz de usuario (#[i GUI - Graphical User Interface]), esta es la parte del sitio #[i web] con la cual los usuarios interactúan y este se despliega del lado del cliente; está orientado al lenguaje de marcas o etiquetas, todo lo visual de un sitio #[i web], tamaños, colores, formas, formatos y renderizado de información al usuario. 
    ...
    #t_2_2.titulo-segundo(data-aos="flip-up").mb-4
      .h2 2.2 Tipos de arquitectura #[i web]

    p.mb-5(data-aos="flip-up") Los diferentes tipos de arquitecturas #[i web] se pueden catalogar dada su profundidad, cantidad de interacciones con el usuario al dar clic, como las siguientes: 

    .cajon.color-acento-botones.p-4.mb-5(data-aos="flip-up")
      p.mb-0 #[strong.recua_bg1.p-1 Arquitectura vertical:] son aquellos sitios #[i web] que emplean una gran cantidad de categorías, para organizar la información, dejando una gran distancia entre el home y la última página posible, este distanciamiento se mide en clics realizados por el usuario al momento de efectuar la navegación en el sitio.
    ...
    .cajon.color-acento-botones.p-4.mb-5(data-aos="flip-up")
      p.mb-0 #[strong.recua_bg1.p-1 Arquitectura Horizontal:] la arquitectura #[i web] horizontal o plana, es aquella que tiene la posibilidad de acceder a todo el contenido del sitio #[i web], con uno o dos clics nada más; se trata del método de distribución de información ideal, además los bots (programa informático que actúa como un robot) podrán leer los patrones presentes el sitio #[i web] más rápido y esto resulta muy positivo. En la siguiente gráfica se puede visualizar este tipo de arquitectura:
    ...
    AcordionAA.mb-5.acordion(tipo="a" clase-tarjeta="tarjeta bg_05")(data-aos="flip-up")
      .row.justify-content-center(titulo="Realizar una planificación adecuada")
        ...
        ul.lista-ul--color.li_1
          ...
          li(data-aos="slide-right") 
            i.fas.fa-check
            p.mb-0 Página #[em web] de servicios
          li(data-aos="slide-left") 
            i.fas.fa-check
